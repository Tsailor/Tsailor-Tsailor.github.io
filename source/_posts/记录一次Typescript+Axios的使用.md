---
    title: 记录一次Typescript+Axios的使用
    date: 2021-10-26
    tags: 前端基础
---

在使用typescript中使用axios时，很多资料都是用any来处理返回值得类型

于是，记录一次Typescript+Axios的使用
<!--more-->
axios封装
```typescript
...
export const login = (params: LoginParams):AxiosResponseType<User> => {
